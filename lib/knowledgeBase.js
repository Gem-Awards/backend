...
const KB = [
  {
    ...
    content:
      "If an order arrives damaged, isn't what you expected, or something's wrong with it, the customer should submit a support ticket via the form on the Help page (gemawards.com/help) - it requires a clear photo of the issue. All shipments are insured. Claims are reviewed within 1 business day.",
    keywords: [
      'damaged',
      'broken',
      'wrong item',
